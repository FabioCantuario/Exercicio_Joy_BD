...
create table sessao (
  ...
  localizacaoSessao VARCHAR(30) not NULL
);
...
INSERT into livro (tituloLivro,autorLivro,fkIdSessao) VALUES
    ...
    ('Conceito de IOS', 'Pressman, Roger S.',10);
...
from emprestimo
join aluno 
ON emprestimo.fkidaluno = aluno.idaluno;
